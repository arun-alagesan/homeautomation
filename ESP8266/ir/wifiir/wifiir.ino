...
void buildWebsite(){
  ...
  webSite+="<TR><TD> Websocket response for IR sensor </TD></TR>";
...
void buildJavascript(){
  ...
  javaScript+="    document.getElementById('distance').scrollTop = document.getElementById("distance").scrollHeight ; \n";
  javaScript+="  }\n";
  javaScript+="}\n";
  javaScript+="</SCRIPT>\n";
}
